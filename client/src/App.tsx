...
import PatientProfileEnhanced from "@/pages/patients/PatientProfileEnhanced";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/manage-clinics" component={ManageClinics} />
      <Route path="/dashboard" component={DoctorDashboard} />
      <Route path="/patients" component={PatientList} />
      <Route path="/patients/:id/profile" component={PatientProfileEnhanced} />
