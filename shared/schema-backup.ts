...
export const clinics = pgTable("clinics", {
  ...
  statusIdx: index("idx_clinics_status").on(table.status),
}));
...
export const users = pgTable("users", {
  ...
  clinicIdIdx: index("idx_users_clinic_id").on(table.clinic_id),
...
export const patients = pgTable("patients", {
  ...
  clinicIdIdx: index("idx_patients_clinic_id").on(table.clinic_id),
  fileNumberIdx: index("idx_patients_file_number").on(table.file_number),
  fullNameIdx: index("idx_patients_full_name").on(table.full_name),
}));
...
export const appointments = pgTable("appointments", {
  ...
  clinicDateIdx: index("idx_appointments_clinic_date").on(table.clinic_id, table.appointment_date),
...
export const consultations = pgTable("consultations", {
  ...
  patientIdx: index("idx_consultations_patient").on(table.patient_id),
  doctorIdx: index("idx_consultations_doctor").on(table.doctor_id),
  appointmentIdx: index("idx_consultations_appointment").on(table.appointment_id),
...
export const referrals = pgTable("referrals", {
  ...
  patientIdx: index("idx_referrals_patient").on(table.patient_id),
  fromDoctorIdx: index("idx_referrals_from_doctor").on(table.from_doctor_id),
  toDoctorIdx: index("idx_referrals_to_doctor").on(table.to_doctor_id),
